  ...
  <div>
      ...
      <section>
        <ul class="userInfoBox">
          ...
          <li>
            ...
            <el-switch v-model="state" on-color="#13ce66" off-color="#aaa">
            </el-switch>
          </li>
          <li v-show="state">
          ...
          <li v-show="state">
            ...
            <el-input type="textarea" :rows="3" placeholder="请输入内容" v-model="userInfoObj.description">
    ...
    <div v-show="!isEdit" class="tcommonBox">
      <header>
        <h1>
          个人中心
          <button class="gotoEdit" @click="isEdit=!isEdit"><i class="fa fa-wa fa-edit"></i>编辑</button>
        </h1>
